...
public class ServicioRepository {
    ...
    static {
        ...
        servicios.add(new Servicio(2L, "Limpieza del Hogar", "Servicio de limpieza profunda", "Limpieza", 35.0, "limpieza.jpg", true, 5));
        ...
        servicios.add(new Servicio(5L, "Reparación de Electrodomésticos", "Arreglo de neveras, lavadoras, etc", "Electrodomésticos", 70.0, "electrodomesticos.jpg", true, 4));
        servicios.add(new Servicio(6L, "Pintura", "Pintura de interiores y exteriores", "Pintura", 45.0, "pintura.jpg", true, 5));
        idCounter = 7L;
    }
